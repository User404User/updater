...
SHOREBIRD_EXPORT bool shorebird_should_auto_update_net(void);

SHOREBIRD_EXPORT uintptr_t shorebird_current_boot_patch_number_net(void);

SHOREBIRD_EXPORT uintptr_t shorebird_next_boot_patch_number_net(void);

SHOREBIRD_EXPORT char *shorebird_next_boot_patch_path_net(void);

SHOREBIRD_EXPORT void shorebird_free_string_net(char *s);

SHOREBIRD_EXPORT bool shorebird_check_for_update_net(void);

SHOREBIRD_EXPORT
bool shorebird_check_for_downloadable_update_net(const char *c_channel);

SHOREBIRD_EXPORT void shorebird_update_net(void);

SHOREBIRD_EXPORT
const struct UpdateResult *shorebird_update_with_result_net(const char *c_channel);

SHOREBIRD_EXPORT
void shorebird_free_update_result_net(const struct UpdateResult *result);
...
SHOREBIRD_EXPORT void shorebird_report_launch_failure_net(void);

SHOREBIRD_EXPORT void shorebird_report_launch_success_net(void);
