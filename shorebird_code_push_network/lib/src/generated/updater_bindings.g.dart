...
class UpdaterBindings {
  ...
  /// patched.
  Future<int?> shorebird_current_boot_patch_number() async {
  ...
  /// no next patch.
  Future<int?> shorebird_next_boot_patch_number() async {
  ...
  bool shorebird_update_base_url(
    ffi.Pointer<ffi.Char> c_base_url,
  ) {
    return _shorebird_update_base_url(
      c_base_url,
    );
  }

  late final _shorebird_update_base_urlPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>)>>(
  ...
  late final _shorebird_init_netPtr = _lookup<
      ffi.NativeFunction<
          ffi.Bool Function(ffi.Pointer<AppParameters>, FileCallbacks,
              ffi.Pointer<ffi.Char>)>>('shorebird_init_net');
  late final _shorebird_init_net = _shorebird_init_netPtr.asFunction<
      bool Function(
          ffi.Pointer<AppParameters>, FileCallbacks, ffi.Pointer<ffi.Char>)>();

  bool shorebird_should_auto_update_net() {
    return _shorebird_should_auto_update_net();
  }

  late final _shorebird_should_auto_update_netPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function()>>(
          'shorebird_should_auto_update_net');
  late final _shorebird_should_auto_update_net =
      _shorebird_should_auto_update_netPtr.asFunction<bool Function()>();

  int shorebird_current_boot_patch_number_net() {
    return _shorebird_current_boot_patch_number_net();
  }

  late final _shorebird_current_boot_patch_number_netPtr =
      _lookup<ffi.NativeFunction<ffi.UintPtr Function()>>(
          'shorebird_current_boot_patch_number_net');
  late final _shorebird_current_boot_patch_number_net =
      _shorebird_current_boot_patch_number_netPtr.asFunction<int Function()>();

  int shorebird_next_boot_patch_number_net() {
    return _shorebird_next_boot_patch_number_net();
  }

  late final _shorebird_next_boot_patch_number_netPtr =
      _lookup<ffi.NativeFunction<ffi.UintPtr Function()>>(
          'shorebird_next_boot_patch_number_net');
  late final _shorebird_next_boot_patch_number_net =
      _shorebird_next_boot_patch_number_netPtr.asFunction<int Function()>();

  ffi.Pointer<ffi.Char> shorebird_next_boot_patch_path_net() {
    return _shorebird_next_boot_patch_path_net();
  }

  late final _shorebird_next_boot_patch_path_netPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'shorebird_next_boot_patch_path_net');
  late final _shorebird_next_boot_patch_path_net =
      _shorebird_next_boot_patch_path_netPtr
          .asFunction<ffi.Pointer<ffi.Char> Function()>();

  void shorebird_free_string_net(
    ffi.Pointer<ffi.Char> s,
  ) {
    return _shorebird_free_string_net(
      s,
    );
  }

  late final _shorebird_free_string_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
          'shorebird_free_string_net');
  late final _shorebird_free_string_net = _shorebird_free_string_netPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  bool shorebird_check_for_update_net() {
    return _shorebird_check_for_update_net();
  }

  late final _shorebird_check_for_update_netPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function()>>(
          'shorebird_check_for_update_net');
  late final _shorebird_check_for_update_net =
      _shorebird_check_for_update_netPtr.asFunction<bool Function()>();

  bool shorebird_check_for_downloadable_update_net(
    ffi.Pointer<ffi.Char> c_channel,
  ) {
    return _shorebird_check_for_downloadable_update_net(
      c_channel,
    );
  }

  late final _shorebird_check_for_downloadable_update_netPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>)>>(
          'shorebird_check_for_downloadable_update_net');
  late final _shorebird_check_for_downloadable_update_net =
      _shorebird_check_for_downloadable_update_netPtr
          .asFunction<bool Function(ffi.Pointer<ffi.Char>)>();

  void shorebird_update_net() {
    return _shorebird_update_net();
  }

  late final _shorebird_update_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('shorebird_update_net');
  late final _shorebird_update_net =
      _shorebird_update_netPtr.asFunction<void Function()>();

  ffi.Pointer<UpdateResult> shorebird_update_with_result_net(
    ffi.Pointer<ffi.Char> c_channel,
  ) {
    return _shorebird_update_with_result_net(
      c_channel,
    );
  }

  late final _shorebird_update_with_result_netPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<UpdateResult> Function(
              ffi.Pointer<ffi.Char>)>>('shorebird_update_with_result_net');
  late final _shorebird_update_with_result_net =
      _shorebird_update_with_result_netPtr.asFunction<
          ffi.Pointer<UpdateResult> Function(ffi.Pointer<ffi.Char>)>();

  void shorebird_free_update_result_net(
    ffi.Pointer<UpdateResult> result,
  ) {
    return _shorebird_free_update_result_net(
      result,
    );
  }

  late final _shorebird_free_update_result_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<UpdateResult>)>>(
          'shorebird_free_update_result_net');
  late final _shorebird_free_update_result_net =
      _shorebird_free_update_result_netPtr
          .asFunction<void Function(ffi.Pointer<UpdateResult>)>();

  void shorebird_start_update_thread_net() {
    return _shorebird_start_update_thread_net();
  }

  late final _shorebird_start_update_thread_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
          'shorebird_start_update_thread_net');
  late final _shorebird_start_update_thread_net =
      _shorebird_start_update_thread_netPtr.asFunction<void Function()>();

  bool shorebird_update_base_url_net(
    ffi.Pointer<ffi.Char> c_base_url,
  ) {
    return _shorebird_update_base_url_net(
      c_base_url,
    );
  }

  late final _shorebird_update_base_url_netPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>)>>(
  ...
  late final _shorebird_report_launch_start_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
          'shorebird_report_launch_start_net');
  late final _shorebird_report_launch_start_net =
      _shorebird_report_launch_start_netPtr.asFunction<void Function()>();

  void shorebird_report_launch_failure_net() {
    return _shorebird_report_launch_failure_net();
  }

  late final _shorebird_report_launch_failure_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
          'shorebird_report_launch_failure_net');
  late final _shorebird_report_launch_failure_net =
      _shorebird_report_launch_failure_netPtr.asFunction<void Function()>();

  void shorebird_report_launch_success_net() {
    return _shorebird_report_launch_success_net();
  }

  late final _shorebird_report_launch_success_netPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
          'shorebird_report_launch_success_net');
  late final _shorebird_report_launch_success_net =
      _shorebird_report_launch_success_netPtr.asFunction<void Function()>();

  ffi.Pointer<ffi.Char> shorebird_get_app_id_net() {
    return _shorebird_get_app_id_net();
  }

  late final _shorebird_get_app_id_netPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'shorebird_get_app_id_net');
  late final _shorebird_get_app_id_net = _shorebird_get_app_id_netPtr
      .asFunction<ffi.Pointer<ffi.Char> Function()>();
  ...
  late final _shorebird_get_release_version_netPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'shorebird_get_release_version_net');
  late final _shorebird_get_release_version_net =
      _shorebird_get_release_version_netPtr
          .asFunction<ffi.Pointer<ffi.Char> Function()>();
}
