...
use crate::{updater_network as updater, UpdateStatus};
...
mod network_exports {
    ...
    #[no_mangle]
    pub extern "C" fn shorebird_init_net(
        c_params: *const AppParameters,
        c_file_callbacks: FileCallbacks,
        c_yaml: *const c_char,
    ) -> bool {
        super::shorebird_init(c_params, c_file_callbacks, c_yaml)
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_should_auto_update_net() -> bool {
        super::shorebird_should_auto_update()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_current_boot_patch_number_net() -> usize {
        super::shorebird_current_boot_patch_number()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_next_boot_patch_number_net() -> usize {
        super::shorebird_next_boot_patch_number()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_next_boot_patch_path_net() -> *mut c_char {
        super::shorebird_next_boot_patch_path()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_free_string_net(s: *mut c_char) {
        unsafe { super::shorebird_free_string(s) }
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_check_for_update_net() -> bool {
        super::shorebird_check_for_update()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_check_for_downloadable_update_net(c_channel: *const c_char) -> bool {
        super::shorebird_check_for_downloadable_update(c_channel)
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_update_net() {
        super::shorebird_update()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_update_with_result_net(c_channel: *const c_char) -> *const UpdateResult {
        super::shorebird_update_with_result(c_channel)
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_free_update_result_net(result: *const UpdateResult) {
        unsafe { super::shorebird_free_update_result(result as *mut UpdateResult) }
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_start_update_thread_net() {
        super::shorebird_start_update_thread()
    }
    ...
    #[no_mangle]
    pub extern "C" fn shorebird_report_launch_start_net() {
        super::shorebird_report_launch_start()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_report_launch_failure_net() {
        super::shorebird_report_launch_failure()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_report_launch_success_net() {
        super::shorebird_report_launch_success()
    }
    
    #[no_mangle]
    pub extern "C" fn shorebird_get_app_id_net() -> *mut c_char {
        super::shorebird_get_app_id()
    }
